  ...
  return (
    <>
      ...
      <p className="para">
        ...
        the expected performance of these different heuristics in different use
        cases and explain this performance with analysis of the scholarly
      ...
      <p className="para">
        ...
        user-requests from the past to train an ML model, with the idea that it
      ...
      <p className="para">
        ...
        the 14-day Wikipedia trace to simulate a real-world applicable request
        sequence. To test specific cases, I wrote the following 3 traces: (1) A
        trace simulating some operations with volatile variables on a working
        set which is called several times (2) A trace which contains 4 chunks of
        requests, where all 4 chunks repeat at random a few requests and the
        chunks contain only very few overlapping requests (3) A trace of many
        very small requests with randomly generated IDs and a few interspersed
        very large (500x) requests which always have the same ID. Testing with
        ...
        the cache among many random very small requests.
      </p>
      <p className="para">
        I used variable cache sizes, ranging from ones where most caches have
        trouble getting any hits to ones where the better algorithms approximate
      ...
      <p className="para">
        ...
        forces eviction and there is really only one item to evict, even though
      ...
      <p className="bib">
        1: Berger, Daniel S., Ramesh K. Sitaraman, and Mor Harchol-Balter. 2017.
        “AdaptSize: Orchestrating the Hot Object Memory Cache in a Content
        Delivery Network.” usenix 14th (March): 16.{" "}
      </p>
      <p className="bib">
        2: Blankstein, Aaron, Siddhartha Sen, and Michael J. Freedman. 2017.
        “Hyperbolic Caching: Flexible Caching for Ib Applications.” Usenix
        17:13.
        https://www.usenix.org/system/files/conference/atc17/atc17-blankstein.pdf.
      </p>
      <p className="bib">
        3: Huang, Qi, Robbert van Renesse, Wyatt Lloyd, Sanjeev Kumar, Harry C.
        Li, and Ken Birman. 2011. “An Analysis of Facebook Photo Caching.” 17.
        https://www.cs.cornell.edu/~qhuang/papers/sosp_fbanalysis.pdf.
      </p>
      <p className="bib">
        4: Putze, Felix, Peter Sanders, and Jonannes Singler. n.d. “Cache-,
        Hash- and Space-Efficient Bloom Filters.”
        https://www.cs.amherst.edu/~ccmcgeoch/cs34/papers/cacheefficientbloomfilters-jea.pdf.
      </p>
      <p className="bib">
        5: Song, Zhenyu, Daniel S. Berger, Kai Li, and Wyatt Lloyd. 2020.
        “Learning Relaxed Belady for Content Distribution Network Caching.”
        usenix 17th:17.
        https://www.usenix.org/system/files/nsdi20-paper-song.pdf.
      </p>
      <p className="bib">
        6: Vietri, Giuseppe, Liana V. Rodriguez, Indy A. Martinez, Steven Lyons,
